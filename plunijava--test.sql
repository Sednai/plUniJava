...
CREATE OR REPLACE FUNCTION b_test_int1(int) RETURNS int AS 'B|ai/sedn/plunijava/Tests|test_int1' LANGUAGE UJAVA;
CREATE OR REPLACE FUNCTION g_test_int1(int) RETURNS int AS 'G|ai/sedn/plunijava/Tests|test_int1' LANGUAGE UJAVA;

SELECT f_test_int1(3);
SELECT b_test_int1(7);
SELECT g_test_int1(9);

CREATE OR REPLACE FUNCTION f_test_int2(int,int) RETURNS int AS 'F|ai/sedn/plunijava/Tests|test_int2' LANGUAGE UJAVA;
CREATE OR REPLACE FUNCTION b_test_int2(int,int) RETURNS int AS 'B|ai/sedn/plunijava/Tests|test_int2' LANGUAGE UJAVA;
CREATE OR REPLACE FUNCTION g_test_int2(int,int) RETURNS int AS 'G|ai/sedn/plunijava/Tests|test_int2' LANGUAGE UJAVA;

SELECT f_test_int2(3,5);
SELECT b_test_int2(7,3);
SELECT g_test_int2(9,11);

CREATE OR REPLACE FUNCTION f_test_int3(int[]) RETURNS int AS 'F|ai/sedn/plunijava/Tests|test_int3|([I)I' LANGUAGE UJAVA;
CREATE OR REPLACE FUNCTION b_test_int3(int[]) RETURNS int AS 'B|ai/sedn/plunijava/Tests|test_int3|([I)I' LANGUAGE UJAVA;
CREATE OR REPLACE FUNCTION g_test_int3(int[]) RETURNS int AS 'G|ai/sedn/plunijava/Tests|test_int3|([I)I' LANGUAGE UJAVA;

SELECT f_test_int3('{1,2,3,4,5}');
SELECT b_test_int3('{6,5,4,3,2,1}');
SELECT g_test_int3('{1,2,2,1}');

CREATE OR REPLACE FUNCTION f_test_int4(int[]) RETURNS int AS 'F|ai/sedn/plunijava/Tests|test_int4|([[I)I' LANGUAGE UJAVA;
CREATE OR REPLACE FUNCTION b_test_int4(int[]) RETURNS int AS 'B|ai/sedn/plunijava/Tests|test_int4|([[I)I' LANGUAGE UJAVA;
CREATE OR REPLACE FUNCTION g_test_int4(int[]) RETURNS int AS 'G|ai/sedn/plunijava/Tests|test_int4|([[I)I' LANGUAGE UJAVA;
...
-- double
CREATE OR REPLACE FUNCTION f_test_double1(float8) RETURNS float8 AS 'F|ai/sedn/plunijava/Tests|test_double1' LANGUAGE UJAVA;
CREATE OR REPLACE FUNCTION b_test_double1(float8) RETURNS float8 AS 'B|ai/sedn/plunijava/Tests|test_double1' LANGUAGE UJAVA;
CREATE OR REPLACE FUNCTION g_test_double1(float8) RETURNS float8 AS 'G|ai/sedn/plunijava/Tests|test_double1' LANGUAGE UJAVA;

SELECT f_test_double1(3.3);
SELECT b_test_double1(7.7);
SELECT g_test_double1(9.9);

CREATE OR REPLACE FUNCTION f_test_double2(float8,float8) RETURNS float8 AS 'F|ai/sedn/plunijava/Tests|test_double2' LANGUAGE UJAVA;
CREATE OR REPLACE FUNCTION b_test_double2(float8,float8) RETURNS float8 AS 'B|ai/sedn/plunijava/Tests|test_double2' LANGUAGE UJAVA;
CREATE OR REPLACE FUNCTION g_test_double2(float8,float8) RETURNS float8 AS 'G|ai/sedn/plunijava/Tests|test_double2' LANGUAGE UJAVA;

SELECT f_test_double2(3.2,5.5);
SELECT b_test_double2(7.6,3.1);
SELECT g_test_double2(9.3,11.1);

CREATE OR REPLACE FUNCTION f_test_double3(float8[]) RETURNS float8 AS 'F|ai/sedn/plunijava/Tests|test_double3|([D)D' LANGUAGE UJAVA;
CREATE OR REPLACE FUNCTION b_test_double3(float8[]) RETURNS float8 AS 'B|ai/sedn/plunijava/Tests|test_double3|([D)D' LANGUAGE UJAVA;
CREATE OR REPLACE FUNCTION g_test_double3(float8[]) RETURNS float8 AS 'G|ai/sedn/plunijava/Tests|test_double3|([D)D' LANGUAGE UJAVA;
...
CREATE OR REPLACE FUNCTION f_test_double4(float8[]) RETURNS float8 AS 'F|ai/sedn/plunijava/Tests|test_double4|([[D)D' LANGUAGE UJAVA;
CREATE OR REPLACE FUNCTION b_test_double4(float8[]) RETURNS float8 AS 'B|ai/sedn/plunijava/Tests|test_double4|([[D)D' LANGUAGE UJAVA;
CREATE OR REPLACE FUNCTION g_test_double4(float8[]) RETURNS float8 AS 'G|ai/sedn/plunijava/Tests|test_double4|([[D)D' LANGUAGE UJAVA;
...
CREATE OR REPLACE FUNCTION f_test_complextype1(int,float8) RETURNS TESTTYPE1 AS 'F|ai/sedn/plunijava/Tests|test_complextype1|(ID)Lai/sedn/plunijava/TestType1;' LANGUAGE UJAVA;
CREATE OR REPLACE FUNCTION b_test_complextype1(int,float8) RETURNS TESTTYPE1 AS 'B|ai/sedn/plunijava/Tests|test_complextype1|(ID)Lai/sedn/plunijava/TestType1;' LANGUAGE UJAVA;
CREATE OR REPLACE FUNCTION g_test_complextype1(int,float8) RETURNS TESTTYPE1 AS 'G|ai/sedn/plunijava/Tests|test_complextype1|(ID)Lai/sedn/plunijava/TestType1;' LANGUAGE UJAVA;

SELECT f_test_complextype1(999,0.333);
SELECT b_test_complextype1(111,0.111);
SELECT g_test_complextype1(321,0.321);

CREATE OR REPLACE FUNCTION f_test_complextype2(TESTTYPE1[]) RETURNS TESTTYPE1 AS 'F|ai/sedn/plunijava/Tests|test_complextype2|([Lai/sedn/plunijava/TestType1;)Lai/sedn/plunijava/TestType1;' LANGUAGE UJAVA;
CREATE OR REPLACE FUNCTION b_test_complextype2(TESTTYPE1[]) RETURNS TESTTYPE1 AS 'B|ai/sedn/plunijava/Tests|test_complextype2|([Lai/sedn/plunijava/TestType1;)Lai/sedn/plunijava/TestType1;' LANGUAGE UJAVA;
CREATE OR REPLACE FUNCTION g_test_complextype2(TESTTYPE1[]) RETURNS TESTTYPE1 AS 'G|ai/sedn/plunijava/Tests|test_complextype2|([Lai/sedn/plunijava/TestType1;)Lai/sedn/plunijava/TestType1;' LANGUAGE UJAVA;
...
CREATE OR REPLACE FUNCTION f_test_njdbc1() RETURNS SETOF TESTTYPE1 AS 'S|ai/sedn/plunijava/Tests|test_njdbc1|()Ljava/util/Iterator;' LANGUAGE UJAVA;

SELECT f_test_njdbc1();

CREATE TYPE TESTTYPE3 as (A boolean);
CREATE TABLE test_table2(id int, data boolean);
INSERT INTO test_table2 (id,data) VALUES (1,'t'),(2,'f'),(3,'t');

CREATE OR REPLACE FUNCTION f_test_njdbc2() RETURNS SETOF TESTTYPE3 AS 'S|ai/sedn/plunijava/Tests|test_njdbc2|()Ljava/util/Iterator;' LANGUAGE UJAVA;
...
CREATE TYPE TESTTYPE5 as (A int, B float4);
CREATE TABLE test_table5(id int, data float4[]);
INSERT INTO test_table5 (id,data) VALUES (1,'{0.1}'),(2,'{0.2}'),(3,'{0.3}');

CREATE OR REPLACE FUNCTION f_test_njdbc5() RETURNS SETOF TESTTYPE5 AS 'S|ai/sedn/plunijava/Tests|test_njdbc5|()Ljava/util/Iterator;' LANGUAGE UJAVA;
